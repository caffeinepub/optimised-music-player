...
const Library = createLucideIcon("library", __iconNode$r);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const ListMusic = createLucideIcon("list-music", __iconNode$q);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Minimize2 = createLucideIcon("minimize-2", __iconNode$m);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Repeat1 = createLucideIcon("repeat-1", __iconNode$f);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Shuffle = createLucideIcon("shuffle", __iconNode$c);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
class AudioEngine {
  constructor() {
    ...
    __publicField(this, "bassFilter", null);
    __publicField(this, "midFilter", null);
    __publicField(this, "trebleFilter", null);
    __publicField(this, "crossfadeSeconds", 0);
    __publicField(this, "isFadingOut", false);
  ...
  initAudioContext() {
    ...
    this.midFilter.frequency.value = 1e3;
    this.trebleFilter.type = "highshelf";
    this.trebleFilter.frequency.value = 4e3;
    this.source.connect(this.bassFilter).connect(this.midFilter).connect(this.trebleFilter).connect(this.gainNode).connect(this.ctx.destination);
  }
  checkCrossfade() {
    if (!this.crossfadeSeconds || !this.gainNode || !this.ctx) return;
    const remaining = (this.audio.duration || 0) - this.audio.currentTime;
    if (remaining > 0 && remaining <= this.crossfadeSeconds && !this.isFadingOut) {
      this.isFadingOut = true;
      const now2 = this.ctx.currentTime;
      this.gainNode.gain.cancelScheduledValues(now2);
      this.gainNode.gain.setValueAtTime(this.gainNode.gain.value, now2);
      this.gainNode.gain.linearRampToValueAtTime(0, now2 + remaining);
    }
  }
  loadTrack(url) {
    ...
    if (this.gainNode && this.ctx) {
      const now2 = this.ctx.currentTime;
      this.gainNode.gain.cancelScheduledValues(now2);
      this.gainNode.gain.setValueAtTime(0, now2);
      this.gainNode.gain.linearRampToValueAtTime(
        1,
        now2 + Math.min(this.crossfadeSeconds, 1)
      );
    }
    this.audio.src = url;
    this.audio.load();
  ...
  play() {
    ...
    if (((_a2 = this.ctx) == null ? void 0 : _a2.state) === "suspended") {
      this.ctx.resume();
    }
    if (this.gainNode && !this.isFadingOut) {
      const now2 = this.ctx.currentTime;
      this.gainNode.gain.cancelScheduledValues(now2);
      this.gainNode.gain.setValueAtTime(1, now2);
    }
  ...
  setVolume(v2) {
    this.audio.volume = Math.max(0, Math.min(1, v2));
  }
  seekForward(s = 10) {
...
async function saveTrack(file) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const req = store.add({ ...track2, blob: file });
    req.onsuccess = () => resolve(track2);
    ...
    (set, get) => ({
      ...
      addFiles: async (files) => {
        ...
        for (const file of Array.from(files)) {
          ...
          try {
            const track2 = await saveTrack(file);
            newTracks.push({ ...track2, blobUrl: URL.createObjectURL(file) });
          } catch (e) {
            console.error(e);
          }
        }
      ...
      deleteTrackById: async (id) => {
        ...
        set((s) => {
          ...
          return {
            ...
            currentTrack: ((_a2 = s.currentTrack) == null ? void 0 : _a2.id) === id ? null : s.currentTrack
          };
        });
      },
      incrementPlayCount: (id) => set((s) => ({
        playCounts: { ...s.playCounts, [id]: (s.playCounts[id] ?? 0) + 1 }
      })),
      playTrack: (track2) => {
        const { queue } = get();
        let idx = queue.findIndex((t) => t.id === track2.id);
        if (idx === -1) {
          const tracks = get().tracks;
          const ti = tracks.findIndex((t) => t.id === track2.id);
        ...
        if (track2.blobUrl) {
          audioEngine.loadTrack(track2.blobUrl);
          audioEngine.play().catch(console.error);
        }
        get().incrementPlayCount(track2.id);
        set((s) => ({
          currentTrack: track2,
          isPlaying: true,
          recentlyPlayed: [
            track2.id,
            ...s.recentlyPlayed.filter((id) => id !== track2.id)
          ].slice(0, 50)
        }));
      },
      togglePlayPause: () => {
      ...
      nextTrack: () => {
        ...
        const track2 = queue[next];
        if (track2 == null ? void 0 : track2.blobUrl) {
          audioEngine.loadTrack(track2.blobUrl);
          audioEngine.play().catch(console.error);
        }
        get().incrementPlayCount(track2.id);
      ...
      prevTrack: () => {
        ...
        const track2 = queue[prev];
        if (track2 == null ? void 0 : track2.blobUrl) {
          audioEngine.loadTrack(track2.blobUrl);
          audioEngine.play().catch(console.error);
        }
        set({ currentTrack: track2, queueIndex: prev, isPlaying: true });
      },
      seekTo: (t) => {
      ...
      addToQueue: (track2) => set((s) => ({ queue: [...s.queue, track2] })),
      removeFromQueue: (index2) => set((s) => ({
        queue: s.queue.filter((_, i) => i !== index2),
        queueIndex: index2 < s.queueIndex ? s.queueIndex - 1 : index2 === s.queueIndex ? Math.min(s.queueIndex, s.queue.length - 2) : s.queueIndex
      })),
      ...
      addToPlaylist: (plId, tId) => set((s) => ({
        playlists: s.playlists.map(
          (p) => p.id === plId && !p.trackIds.includes(tId) ? { ...p, trackIds: [...p.trackIds, tId] } : p
        )
      })),
      removeFromPlaylist: (plId, tId) => set((s) => ({
        playlists: s.playlists.map(
          (p) => p.id === plId ? { ...p, trackIds: p.trackIds.filter((id) => id !== tId) } : p
        )
      })),
      ...
      setShowNowPlaying: (v2) => set({ showNowPlaying: v2 }),
      setEQBand: (band, gain) => {
...
function hashHue(str) {
  ...
  for (let i = 0; i < str.length; i++)
    hash = hash * 31 + str.charCodeAt(i) & 16777215;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "48", height: "48", fill: `hsl(${hue},45%,20%)` }),
...
function TrackRow({
  ...
  const isCurrentTrack = (currentTrack == null ? void 0 : currentTrack.id) === track2.id;
  const isFav = favorites.includes(track2.id);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      ...
      onClick: () => playTrack(track2),
      "data-ocid": `track.item.${index2 + 1}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              isCurrentTrack && isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#1DB954" }, children: "▶" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "group-hover:hidden", children: index2 + 1 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Play,
                {
                  size: 14,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            "data-ocid": `track.open_modal_button.${index2 + 1}`,
            title: "Open Now Playing",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderArt, { title: track2.title, size: 40, className: "rounded" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs truncate", style: { color: "#b3b3b3" }, children: track2.artist })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            style: { color: "#b3b3b3" },
            children: formatDuration(track2.duration ?? 0)
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onClick: (e) => {
                e.stopPropagation();
                toggleFavorite(track2.id);
              },
              "data-ocid": `track.toggle.${index2 + 1}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 14, fill: isFav ? "currentColor" : "none" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              title: "Add to queue",
              "data-ocid": `track.secondary_button.${index2 + 1}`,
          ...
          showDelete && onDelete && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              "data-ocid": `track.delete_button.${index2 + 1}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 14 })
            }
          ),
          playlistId && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              className: "w-7 h-7 flex items-center justify-center rounded-full hover:text-red-400 transition-colors",
              ...
              onClick: (e) => {
                e.stopPropagation();
                removeFromPlaylist(playlistId, track2.id);
              },
              "data-ocid": `track.delete_button.${index2 + 1}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 14 })
            }
...
function FavoritesView() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", "data-ocid": "favorites.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 28, fill: "white", className: "text-white" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-white", children: "Liked Songs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "#b3b3b3" }, children: [
          favTracks.length,
          " song",
          favTracks.length !== 1 ? "s" : ""
        ] })
      ] })
    ] }),
    favTracks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16", "data-ocid": "favorites.empty_state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Heart,
        {
          size: 48,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold", children: "Songs you like will appear here" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-2", style: { color: "#b3b3b3" }, children: "Save songs by tapping the heart icon" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col", children: favTracks.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TrackRow, { track: t, index: i }, t.id)) })
  ] });
}
function LibraryView() {
  ...
  const handleFiles = async (files) => {
    ...
    ue.success(`Added ${files.length} track(s)`);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-white", children: "Your Library" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
        ...
        tracks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Music, { size: 28, style: { color: "#1DB954" } })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-lg", children: "Your library is empty" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", style: { color: "#b3b3b3" }, children: "Upload audio files or drag & drop them here" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "col-span-2", children: "Title" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Artist" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: "Duration" })
              ]
            }
          ),
          tracks.map((track2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            TrackRow,
            {
              track: track2,
              index: i,
...
function PlaylistView({ playlistId }) {
  const { tracks, playlists, renamePlaylist, deletePlaylist, setCurrentView } = useMusicStore();
  const playlist = playlists.find((p) => p.id === playlistId);
  if (!playlist)
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 text-center", style: { color: "#b3b3b3" }, children: "Playlist not found" });
  const playlistTracks = playlist.trackIds.map((id) => tracks.find((t) => t.id === id)).filter(Boolean);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", "data-ocid": "playlist.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: { background: "#282828" },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ListMusic, { size: 28, style: { color: "#1DB954" } })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-white truncate", children: playlist.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "#b3b3b3" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: () => {
              ...
              if (n == null ? void 0 : n.trim()) renamePlaylist(playlistId, n.trim());
            },
    ...
    playlistTracks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        className: "text-center py-12",
        style: { color: "#b3b3b3" },
        "data-ocid": "playlist.empty_state",
        children: "No songs yet. Add songs from the Library."
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col", children: playlistTracks.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TrackRow, { track: t, index: i, playlistId }, t.id)) })
  ] });
}
function QueueView() {
  const { queue, queueIndex, currentTrack, removeFromQueue, playTrack } = useMusicStore();
  const upNext = queue.slice(queueIndex + 1);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", "data-ocid": "queue.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-white mb-6", children: "Queue" }),
    currentTrack && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#b3b3b3" }, children: currentTrack.artist })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#b3b3b3" }, children: formatDuration(currentTrack.duration ?? 0) })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      upNext.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1", children: upNext.map((track2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        QueueItem,
        {
          track: track2,
          index: i,
          onPlay: () => playTrack(track2),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderArt, { title: track2.title, size: 36, className: "rounded" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm truncate text-white", children: track2.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs truncate", style: { color: "#b3b3b3" }, children: track2.artist })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#b3b3b3" }, children: formatDuration(track2.duration ?? 0) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            "data-ocid": `queue.delete_button.${index2 + 1}`,
...
function SearchView() {
  ...
  const filtered = query.trim() ? tracks.filter(
    (t) => t.title.toLowerCase().includes(query.toLowerCase()) || t.artist.toLowerCase().includes(query.toLowerCase())
  ) : tracks;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", "data-ocid": "search.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-white mb-4", children: "Search" }),
    ...
    filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        ...
        children: query ? `No results for "${query}"` : "No tracks in your library"
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col", children: filtered.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TrackRow, { track: t, index: i }, t.id)) })
  ] });
}
function SmartPlaylistView({ mode }) {
  ...
  const sortedTracks = (() => {
    switch (mode) {
      ...
      case "top-50":
        return [...tracks].sort((a, b) => (playCounts[b.id] ?? 0) - (playCounts[a.id] ?? 0)).slice(0, 50);
      default:
        return tracks;
    }
  })();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", "data-ocid": "smart_playlist.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-2xl font-black mb-4 px-2", children: titles[mode] }),
    sortedTracks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        className: "text-[#535353] px-2",
        "data-ocid": "smart_playlist.empty_state",
        children: "No tracks yet — upload some music!"
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col", children: sortedTracks.map((track2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TrackRow, { track: track2, index: i }, track2.id)) })
  ] });
}
function StatsView() {
  ...
  for (const t of tracks) {
    ...
    artistCounts[t.artist] = (artistCounts[t.artist] ?? 0) + (playCounts[t.id] ?? 0);
  }
  ...
  const StatCard = ({
    ...
    "div",
    {
      ...
      style: {
        background: accent ? "linear-gradient(135deg, #1DB954 0%, #158a3e 100%)" : "#1a1a1a",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", "data-ocid": "stats.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-2xl font-black mb-6", children: "Your Stats" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Library", value: totalTracks, sub: "tracks", accent: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Artists", value: uniqueArtists, sub: "unique" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Liked Songs", value: likedCount, sub: "favorites" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Recently Played", value: recentCount, sub: "tracks" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest font-semibold text-[#b3b3b3] mb-3", children: "Most Played" }),
      mostPlayedTrack.track ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xl font-bold truncate", children: mostPlayedTrack.track.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#b3b3b3] text-sm", children: mostPlayedTrack.track.artist }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-normal text-[#b3b3b3] ml-2", children: "plays" })
                ]
              }
            )
          ]
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#535353] text-sm", children: "Play some tracks to see stats" })
        }
      )
    ] }),
    topArtists.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest font-semibold text-[#b3b3b3] mb-3", children: "Top Artists" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: topArtists.map(([artist, count], i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold truncate", children: artist }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-[#b3b3b3]", children: [
                count,
                " plays"
              ] })
            ] })
...
function MainContent() {
  ...
  if (typeof currentView === "object" && currentView.type === "playlist")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(PlaylistView, { playlistId: currentView.id });
  switch (currentView) {
    case "library":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(LibraryView, {});
    case "search":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SearchView, {});
    case "queue":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(QueueView, {});
    case "favorites":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(FavoritesView, {});
    case "recently-played":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(RecentlyPlayedView, {});
    case "stats":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(StatsView, {});
    case "smart-recently-added":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SmartPlaylistView, { mode: "recently-added" });
    case "smart-most-played":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SmartPlaylistView, { mode: "most-played" });
    case "smart-top-50":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SmartPlaylistView, { mode: "top-50" });
    default:
      return /* @__PURE__ */ jsxRuntimeExports.jsx(LibraryView, {});
  }
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        minWidth: 240,
        maxWidth: 300,
        boxShadow: "0 8px 32px rgba(139,92,246,0.3), 0 0 0 1px rgba(236,72,153,0.1)"
      },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 flex-shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 15 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 15 })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkipForward, { size: 15 })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
...
const PREFIX$1 = "omp-chapters-";
function getChapters(trackId) {
  try {
    const raw = localStorage.getItem(PREFIX$1 + trackId);
    return raw ? JSON.parse(raw) : [];
  } catch {
    return [];
  }
}
function saveChapters(trackId, chapters) {
  localStorage.setItem(PREFIX$1 + trackId, JSON.stringify(chapters));
}
function addChapter(trackId, title, time) {
  const chapters = getChapters(trackId);
  chapters.push({ id: crypto.randomUUID(), title, time });
  chapters.sort((a, b) => a.time - b.time);
  saveChapters(trackId, chapters);
}
function removeChapter(trackId, chapterId) {
...
function ChaptersPanel() {
  ...
  const trackId = currentTrack == null ? void 0 : currentTrack.id;
  ...
  const handleRemove = (chapterId) => {
    if (!currentTrack) return;
    removeChapter(currentTrack.id, chapterId);
    reload();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full p-4 gap-3", "data-ocid": "chapters.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto min-h-0", children: chapters.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#535353] text-sm italic", children: "No chapters yet — add one below" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1", children: chapters.map((ch, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: formatDuration(ch.time)
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-white flex-1 truncate", children: ch.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    currentTrack && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "text",
...
function setLyrics(trackId, text) {
  if (text.trim()) {
...
function LyricsPanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full p-4 gap-3", "data-ocid": "lyrics.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "flex-1 overflow-y-auto rounded-lg p-3 min-h-0",
        style: { background: "rgba(0,0,0,0.3)" },
        children: text ? /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "text-white text-sm leading-relaxed whitespace-pre-wrap font-sans", children: text }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#535353] text-sm italic", children: "No lyrics yet — paste them below" })
      }
    ),
    currentTrack && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          value: text,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: saved ? "Saved!" : "Save Lyrics"
        }
      )
    ] })
  ] });
...
function NowPlayingScreen() {
  ...
  const [showTimerPopover, setShowTimerPopover] = reactExports.useState(false);
  const [customMin, setCustomMin] = reactExports.useState("");
  const touchStartY = reactExports.useRef(null);
  const touchCurrentY = reactExports.useRef(null);
  ...
  reactExports.useEffect(() => {
    ...
    const draw = () => {
      ...
      colors.forEach(([r, g, b], i) => {
        ...
        const x2 = w * (0.2 + Math.sin(t * 6e-3 + i * 1.2) * 0.3);
        const y = h * (0.3 + Math.cos(t * 8e-3 + i * 0.8) * 0.3);
        const rad = Math.min(w, h) * pulse * 0.6;
        const grad = ctx.createRadialGradient(x2, y, 0, x2, y, rad);
  ...
  const iconBtn = (active = false) => `flex items-center justify-center w-12 h-12 rounded-full transition-all ${active ? "text-purple-400" : "text-white/50 hover:text-white hover:bg-white/10"}`;
  const tabs = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-[1] flex flex-col h-full", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center px-4 py-2 relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 -translate-x-1/2 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center px-8 pt-4 pb-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  filter: isPlaying ? "drop-shadow(0 8px 40px rgba(139,92,246,0.6))" : "drop-shadow(0 8px 24px rgba(0,0,0,0.7))",
                  transform: isPlaying ? "scale(1.04)" : "scale(0.97)",
                  transition: "transform 0.4s ease, filter 0.4s ease",
                  borderRadius: 20,
                  overflow: "hidden"
                },
                children: currentTrack ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  PlaceholderArt,
                  {
                    title: currentTrack.title,
                    size: 220,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: (currentTrack == null ? void 0 : currentTrack.title) ?? "No track selected"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: { color: "rgba(255,255,255,0.5)" },
                    children: (currentTrack == null ? void 0 : currentTrack.artist) ?? ""
                  }
                )
              ] }),
              currentTrack && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 22, fill: isFav ? "currentColor" : "none" })
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-1 h-7 justify-center", children: WAVE_BARS.map((bar, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                  width: 3,
                  height: bar.height,
                  background: isPlaying ? WAVE_COLORS[i] : "rgba(255,255,255,0.2)",
                  borderRadius: 2,
            ...
            "div",
            {
              ...
              children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    color: activeTab === tab.key ? "#EC4899" : "rgba(255,255,255,0.4)",
                    borderBottom: activeTab === tab.key ? "2px solid #EC4899" : "2px solid transparent"
                  },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-h-0 overflow-hidden", children: [
            activeTab === "controls" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center px-6 py-4 gap-5 h-full justify-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    step: "0.1",
                    value: progress,
                    onChange: (e) => seekTo(Number.parseFloat(e.target.value) / 100 * duration),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5 w-full justify-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkipBack, { size: 28 })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, #8B5CF6, #EC4899)",
                      boxShadow: "0 0 32px rgba(139,92,246,0.6), 0 0 60px rgba(236,72,153,0.3)",
                      color: "white"
                    },
                    onClick: togglePlayPause,
                    "data-ocid": "now_playing.primary_button",
                    children: isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 32 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 32 })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    onClick: nextTrack,
                    "data-ocid": "now_playing.secondary_button",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkipForward, { size: 28 })
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    title: "Shuffle",
                    "data-ocid": "now_playing.toggle",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffle, { size: 20 })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    title: "Repeat",
                    "data-ocid": "now_playing.toggle",
                    children: repeat === "one" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Repeat1, { size: 20 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Repeat, { size: 20 })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      title: sleepTimer.active ? "Sleep timer active" : "Sleep timer",
                      onClick: () => sleepTimer.active ? clearSleepTimer() : setShowTimerPopover(!showTimerPopover),
                      "data-ocid": "now_playing.toggle",
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Timer, { size: 20 })
                    }
                  ),
                  showTimerPopover && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-sm font-semibold mb-3", children: "Sleep Timer" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2 mb-3", children: [15, 30, 45, 60].map((min) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "button",
                          {
                            type: "button",
            ...
            activeTab === "lyrics" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LyricsPanel, {}) }),
            activeTab === "chapters" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChaptersPanel, {}) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minimize2, { size: 20 })
            }
          )
        ] })
      ]
...
function EqualizerPanel({ open, onClose }) {
  const {
    eqSettings,
    eqPreset,
    crossfade,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-sm", children: "Equalizer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-[#b3b3b3] mb-2 uppercase tracking-wider", children: "Preset" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 mb-4", children: ["bass", "mid", "treble"].map((band) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[#b3b3b3] capitalize", children: band }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                className: "text-xs tabular-nums",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[#b3b3b3]", children: "Crossfade" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs tabular-nums", style: { color: "#1DB954" }, children: [
              crossfade,
              "s"
            ] })
          ] }),
...
function PlayerBar() {
  ...
  const [showTimer, setShowTimer] = reactExports.useState(false);
  const [customMin, setCustomMin] = reactExports.useState("");
  const [showVol, setShowVol] = reactExports.useState(false);
  const [showEQ, setShowEQ] = reactExports.useState(false);
  const progress = duration > 0 ? currentTime / duration * 100 : 0;
  const isFav = currentTrack ? favorites.includes(currentTrack.id) : false;
  const iconBtn = (active = false) => `flex items-center justify-center w-11 h-11 rounded-full transition-all ${active ? "text-purple-400" : "text-white/50 hover:text-white hover:bg-white/10"}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(EqualizerPanel, { open: showEQ, onClose: () => setShowEQ(false) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col px-2 pt-2 pb-2 md:hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 w-full min-w-0 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        style: {
                          background: currentTrack ? "linear-gradient(90deg, #fff, #d8b4fe)" : "none",
            ...
            currentTrack && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 18, fill: isFav ? "currentColor" : "none" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                "data-ocid": "player.toggle",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SlidersHorizontal, { size: 16 })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                className: iconBtn(sleepTimer.active),
                onClick: () => sleepTimer.active ? clearSleepTimer() : setShowTimer(!showTimer),
                style: { width: 40, height: 40, minWidth: 40 },
                "data-ocid": "player.toggle",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 w-full mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                onClick: toggleShuffle,
                "data-ocid": "player.toggle",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffle, { size: 16 })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { size: 22 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 22 })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: cycleRepeat,
                "data-ocid": "player.toggle",
                children: repeat === "one" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Repeat1, { size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Repeat, { size: 16 })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 w-full px-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "text-xs tabular-nums flex-shrink-0",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-3 px-4 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
          ...
          currentTrack && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onClick: () => toggleFavorite(currentTrack.id),
              "data-ocid": "player.toggle",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 16, fill: isFav ? "currentColor" : "none" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2 flex-1 max-w-xl mx-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 flex-shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                "data-ocid": "player.toggle",
                children: voiceActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MicOff, { size: 16 })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: iconBtn(sleepTimer.active),
                onClick: () => sleepTimer.active ? clearSleepTimer() : setShowTimer(!showTimer),
                title: sleepTimer.active ? `Sleep: ${formatTimer(sleepTimer.remaining)}` : "Sleep timer",
                "data-ocid": "player.toggle",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Timer, { size: 16 })
              }
            ),
            sleepTimer.active && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs tabular-nums", style: { color: "#8B5CF6" }, children: formatTimer(sleepTimer.remaining) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  "data-ocid": "player.toggle",
                  children: volume === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeX, { size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { size: 16 })
                }
              ),
              showVol && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
function Sidebar({ onClose }) {
  const { currentView, setCurrentView, playlists, createPlaylist, addFiles } = useMusicStore();
  const fileInputRef = reactExports.useRef(null);
  const navItems = [
    { label: "Library", view: "library", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Library, { size: 18 }) },
    { label: "Search", view: "search", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 18 }) },
    { label: "Queue", view: "queue", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ListMusic, { size: 18 }) },
    { label: "Liked Songs", view: "favorites", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 18 }) },
    {
      label: "Recently Played",
      view: "recently-played",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 18 })
    },
    { label: "Stats", view: "stats", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { size: 18 }) }
  ];
  const smartPlaylists = [
    ...
    { label: "Top 50", view: "smart-top-50", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 16 }) }
  ];
  const isActive = (view) => {
  ...
  const handleFileChange = async (e) => {
    ...
    if ((_a2 = e.target.files) == null ? void 0 : _a2.length) {
      ...
      ue.success(`Added ${e.target.files.length} track(s)`);
    }
    e.target.value = "";
  };
  const handleDrop = async (e) => {
    ...
    if (e.dataTransfer.files.length) {
      ...
      ue.success(`Added ${e.dataTransfer.files.length} track(s)`);
    }
  };
  const navBtn = (view, icon, label, ocid) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      ...
      style: {
        ...
        background: isActive(view) ? "linear-gradient(135deg, rgba(139,92,246,0.35), rgba(236,72,153,0.2))" : "transparent",
        borderLeft: isActive(view) ? "2px solid #8B5CF6" : "2px solid transparent"
      },
      onClick: () => {
        setCurrentView(view);
        onClose();
      ...
      "data-ocid": ocid,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: isActive(view) ? "#a78bfa" : "inherit" }, children: icon }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      onDrop: handleDrop,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 px-3 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0",
              style: { background: "linear-gradient(135deg, #8B5CF6, #EC4899)" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Music2, { size: 16, color: "white" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-0.5", children: navItems.map(
          (item) => navBtn(
            item.view,
            item.icon,
            item.label,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex-1 overflow-y-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center px-3 mb-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-0.5", children: smartPlaylists.map(
              (sp) => navBtn(sp.view, sp.icon, sp.label, `nav.${String(sp.view)}.link`)
            ) })
          ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: () => {
                  ...
                  if (n == null ? void 0 : n.trim()) createPlaylist(n.trim());
                },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
            playlists.map((pl) => {
              const view = { type: "playlist", id: pl.id };
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  style: {
                    ...
                    background: active ? "linear-gradient(135deg, rgba(139,92,246,0.35), rgba(236,72,153,0.2))" : "transparent",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs px-3", style: { color: "rgba(255,255,255,0.2)" }, children: "Drag audio files here to upload" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
...
function Layout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen flex-col", style: { background: "#0a0a14" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
      ...
      sidebarOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 flex md:hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "aside",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { onClose: () => setSidebarOpen(false) })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Music2, { size: 14, color: "white" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MainContent, {}) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MiniPlayer, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PlayerBar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(NowPlayingScreen, {})
  ] });
}
class VoiceAssistant {
  ...
  init(handler) {
    ...
    this.recognition.onresult = (event) => {
      ...
      if (t.includes("next")) (_a2 = this.handler) == null ? void 0 : _a2.call(this, "next");
      else if (t.includes("previous") || t.includes("prev"))
        (_b2 = this.handler) == null ? void 0 : _b2.call(this, "previous");
      else if (t.includes("pause")) (_c2 = this.handler) == null ? void 0 : _c2.call(this, "pause");
      else if (t.includes("play")) (_d2 = this.handler) == null ? void 0 : _d2.call(this, "play");
      else if (t.includes("shuffle")) (_e2 = this.handler) == null ? void 0 : _e2.call(this, "shuffle");
    };
    ...
    this.recognition.onend = () => {
      var _a2;
      if (this.active) (_a2 = this.recognition) == null ? void 0 : _a2.start();
    };
  }
  start() {
    var _a2;
    this.active = true;
    try {
      (_a2 = this.recognition) == null ? void 0 : _a2.start();
    } catch (_) {
    }
  }
  stop() {
    ...
    this.active = false;
    try {
      (_a2 = this.recognition) == null ? void 0 : _a2.stop();
    } catch (_) {
    }
  }
}
